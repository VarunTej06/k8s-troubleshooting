...
1. [Secure your API server](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#secure-your-api-server)
2. [RBAC](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#rbac)
3. [Network Policies](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#network-policies)
4. [Encrypt data at rest](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#encrypt-data-at-rest)
5. [Secure Container Images](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#secure-container-images)
6. [Cluster Monitoring](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#cluster-monitoring)
7. [Upgrades](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#upgrades)
...
- [Enable the Encryption Provider feature by configuring the Kubernetes API server](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#enable-the-encryption-provider-feature-by-configuring-the-kubernetes-api-server)
- [Configure the key management system to store and manage encryption keys](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#configure-the-key-management-system-to-store-and-manage-encryption-keys)
- [Create a Kubernetes Secret object with the encryption key](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#create-a-kubernetes-secret-object-with-the-encryption-key)
- [Configure Kubernetes resources to use the Encryption Provider](https://github.com/VarunTej06/k8s-troubleshooting/blob/main/pro-security/secure-cluster-pro.md#configure-kubernetes-resources-to-use-the-encryption-provider)
